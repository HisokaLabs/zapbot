...
- [Examples](./examples.md): an auto-reply plugin, a downloader plugin, an AI plugin.

New to the codebase? Read [installation.md](./installation.md) first to get a bot running, then [plugin-development.md](./plugin-development.md) to add your first command. [AGENTS.md](../AGENTS.md) at the project root has the coding rules this project (and any AI agent working on it) follows.
